...
Testing:
Before submittibg a pull request, make sure your changes have been tested thouroughly. Include relevant test cases and ensure that existing tests pass.
...
Code review:
All contributions will go through a code review process. Be open to feedback and be willing to make changes as neccessary. 
